  ...
  if (key === KEY) {
    if (logo_source === "") {
      ...
      if (url_image) {
        url = url_image;
        // console.log('url',url)
        // console.log('aspect_ratio',ar)
        n_h_logo = n_w_logo / ar;
        // console.log('url',url)
        // console.log('check',url, n_w_logo, n_h_logo)
      } else if (path) {
        url = path;
        n_h_logo = n_w_logo / ar;
    ...
    //api post
    axios.post('https://studio.pixelixe.com/api/graphic/automation/v1', {
      "document_uid": "c5f66ded44455d4a62b1a4e69f363ad7",
